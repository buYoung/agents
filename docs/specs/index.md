...
| [agent-prompt-improvement-guide.md](agent-prompt-improvement-guide.md) | 번들 agents 시스템 프롬프트 개선의 규칙, 절차, 평가 기준을 한곳에 정리한 통합 문서. |
...
7. `agent-prompt-improvement-guide.md`
8. `pdf-document-authoring-guidelines.md`
9. `opencode-cli-ollama-cloud-glm52-usage-spec.md`
10. `docs/FDD/opencode-plugin-authoring.md`
11. `docs/FDD/opencode-agent-authoring.md`
