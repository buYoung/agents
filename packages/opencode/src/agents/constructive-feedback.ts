...
2. Read only explicitly specified files and explicitly specified \`.agents/<taskId>/*.md\` files. If the target is not confirmed, search narrowly once; if that fails, record it as needs confirmation.
...
5. Do not modify source, document, or configuration files. Do not use \`task\` or \`webfetch\`. File-writing tools may write only to your own artifact \`.agents/<taskId>/constructive-feedback.md\`.
